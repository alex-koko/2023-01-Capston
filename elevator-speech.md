...
# Team4. 고민박살
**안녕하세요, 이화인들만의 진로 정보 공유 커뮤니티, 이화 커리어 업을 개발하고 있는 4조 고민박살 입니다.**

**여러분은 그동안 이화이언, 에브리타임, 오카방을 통해서 진로에 대한 정보들을 얻어보셨을 겁니다. 그럼 그 정보들은 얼마나 가치가 있었나요? 정보를 얻기 위해 들인 시간과 노력만큼 만족스러운 정보들이었나요? 저는 인공지능 모델링 개발자 진로에 대한 정보를 얻고자 3개의 플랫폼을 이용했지만, 한 곳에서는 정보가 없었고, 한 곳에서는 AI 역량 검사에 대한 정보가 더 많았습니다. 오카방에서는 질문에 대한 답보다는 질문하는 사람이 더 많았죠. 기존의 플랫폼들은 정보를 찾는 가성비가 좋지 않았습니다.**

**그런데, 제가 이런 불만을 토로하자 누군가는 이렇게 말했습니다. 정보를 얻기 위해 그만한 노력도 하지 않는 것도 게으른 것이다. 그렇지만 저는 생각이 달랐습니다. 정보를 찾는데 쓰는 우리들의 시간은 소중합니다.**

**또 한 가지, 우리의 정보는 우리만이 공유할 때 비로소 가치가 있습니다. 모두가 공유하는 정보는 정보가 아닌 상식이 됩니다. 이 자리에 있는 많은 벗들이 정보가 유출되는 것에 대해 경계하는 온라인 상의 분위기를 겪어보셨을 것입니다. 때로는 이화인 계정으로만 접근이 가능하도록 설정한 정보를 보신 적도 있으실 겁니다. 이런 불안함은 선의로 정보를 공유할 때 큰 장벽이 되었습니다.**

**저희가 제공하는 이화 커리어 업 서비스는 여러분의 이런 불편을 해소합니다. 우리가 서로를 안전하게 돕고, 도움을 받을 수 있는 온라인 서비스, 이화 커리어 업 소개였습니다. 감사합니다.**
# Team5. TEAJAVA
...
# Team7. COYD
안녕하세요, 그로쓰 7팀 COYD입니다. 저희 프로젝트는 블록체인을 활용한 중고 거래 기부 플랫폼입니다.
이 프로젝트의 핵심은 사람들에게 익숙한 방식인 중고거래로 자연스럽게 기부에 참여할 수 있는 기회를 제공한다는 것입니다. 
기존 플랫폼과의 차별성으로는 먼저, 블록체인을 통한 기부금 사용의 투명성 개선입니다. 실제로 기부를 하지 않는 이유 중 33%가  “기부처에 대한 불신” 때문이라고 답하였습니다. 이 점을 개선하기 위해 플랫폼 내 모든 거래 내역을 누구나 확인할 수 있는 채널에 기록하였습니다. 이 과정에서 기존 중고거래 플랫폼의 고질적인 문제인 거래 사기도 방지할 수 있습니다.
또한, 직접적으로 돈을 기부방식이 아니기 때문에 기부자의 경제적 부담을 줄일 수 있다는 것이 차별점입니다. 당장 나에게 필요 없는 물건을 중고 거래 한 후 그 판매액을 기부하는 형태로 이루어져 물품 판매자는 중고 물품 기부, 구매자는 물품 구입을 통해 기부에 참여하게 되는 것입니다.
저희 프로젝트를 통해 개선된 기부 접근성으로 사회적으로 도움이 필요한 기관에 충분한 지원을 할 수 있게 될 것입니다. 
# Team8. -
...
# Team10. -
안녕하세요, 자취생을 위한 월세 계약 AI 매니저 [믿어방]을 소개하겠습니다.

여러분, 새내기 시절 처음으로 자취를 시작했던 순간을 떠올려봅시다.

꿈꿔왔던 첫 독립을 앞두고 설레어 했으나,

막상 자취방을 구하려니 막막하기만 합니다.

부동산 용어는 낯설고, 중개인과 집주인은 불친절하고, 심지어 전세 사기가 사회적 문제로 대두되는 상황에서 내가 계약을 잘하고 있는지 알기 어렵습니다.

저희는 이렇게 사회초년생들이 부동산 계약 과정 중 겪는 갈등과 피해를 예방하는데 실질적인 도움을 드리기 위해 서비스 [믿어방]을 기획했습니다.

믿어방은 안심하고 전월세 계약을 체결할 수 있도록 돕는 웹 서비스입니다.

단순히 임대차계약서를 사진으로 찍어 올리기만 하면 믿어방이 내 계약서 중 특약 사항을 분석해줍니다. 법적 효력이 없는 특약, 나에게 유리하거나 불리한 특약 등으로 카테고리화하여 이에 맞는 솔루션을 제공합니다.

또한 내가 계약하기로한 집의 등기부등본을 촬영해 업로드하면, 내 집의 등기 상태를 알기 쉽게 해설해주고, 내가 앞으로 어떤 추가 행동을 해야하는지 안내합니다.

이러한 기능을 위해 사진 속 텍스트를 추출하는 OCR 과 문장 유사도를 계산하는 NLP 기술을 도입하였고, 높은 정확도를 가진 모델을 개발하는 중에 있습니다.

저희 믿어방은 부동산 계약에 대한 심리적 진입 장벽을 완화하고,

부당한 임대차계약을 방지하며,

계약 당사자들 간의 원한만 계약 과정을 유도할 수 있습니다.

이상 10 팀 GSD의 믿어방이었습니다.

감사합니다.

# Team11. JeongHyoYeon
저희는 여러 명이 여행을 갈 예정이거나 갔다 온 사람들의 불편함을 해결하고자 합니다.
많은 사람들이 여행을 갔다온 후에 친구와 비용을 정산하고 여행 사진을 정리하는 과정에서 불편함을 겪습니다. 
특히 사진을 많이 찍는 사람이거나 여행 기간이 길어질 경우, 여행 경비 내역과 사진이 정리되지 않고 쌓여간다면 이런 불편함을 더 크게 느낄 것입니다. 
이런 경우, 수동으로 정리하는 것이 비효율적입니다.

저희는 이 문제를 해결하기 위해 딥러닝 얼굴 인식을 이용한 효율적인 그룹별 여행 관리 서비스인 after trip을  제안합니다.
여행 경비 지출내역을 입력하면 서비스가 수식을 이용해 자동으로 정산합니다.
여러 번 계산할 필요 없이 사용자는 서비스가 계산한 결과를 보고 단순 이체만 하면 됩니다.

여행 사진의 인물, 풍경, 음식 등 카테고리 분류는 Yolov5를 이용하고 그 중 얼굴 인식을 이용한 인물별 분류는 MTCNN을 이용합니다.
그렇게 분류된 폴더를 이용해 각 사용자는 원하는 사진만 손쉽게 다운로드 받을 수 있습니다.

그래서 저희는 다인원으로 여행을 갔다 온 후에 비용 정산과 사진 분류를 자동화하여 여행 후의 불편함을 해소할 수 있는 서비스를 만들고자 합니다.
...
줄 수 있습니다.
# Team18. -
우리는 범죄에 취약하다고 여겨지는 지하철, 대합실, PC방, 골목길 등의 시설들보다도 평균 4배 이상 범죄가 발생하는 곳인 편의점에 주목하였습니다. 최근에도 편의점 강력범죄는 끊임없이 발생하고 있고, 기사화 되고 있어 여러 기관과 대중으로부터 점진적인 관심을 이끌고 있기도 합니다. 우리는 편의점 근로자들을 대상으로, 그들이 폭행/흉기난동/살인 등의 강력 범죄 행위에 대해 취약하다는 안전 문제를 해결하고자, 딥러닝을 사용하여 편의점 CCTV를 분석하여 편의점 근로자에게 물리적 위협을 가하는 강력 범죄 행동을 실시간으로 감지하고 자동으로 경찰 기관에 문자 신고하는 서비스를 주력으로 하는 편의점 근로자 종합 안전 서비스인 “편텍트”를 만들고 있습니다. “편텍트”의 사용자는 자동 문자 신고 기능 이외에도 버튼 몇 번으로 신고 시간을 단축한 수동 신고 기능, 상황 녹음 기능, 실시간 위치를 기반으로 한 주변 안전 시설 조회 기능을 이용할 수 있습니다. “편텍트”는 혼자 근무할 때도 골든 타임 내에 빠르게 범죄 상황에 대처할 수 있는 든든한 서비스를 꿈꿉니다. 강력 범죄를 실시간으로 감지하여 자동으로 신고해 주고, 범죄 상황에서 빠르고 효율적인 대처 방식을 제공함으로써 편의점 근무자에게 안심할 수 있는 근무 환경을 제공하는 것은 물론, 편의점에서 일어나는 강력 범죄를 대폭 줄이고 지역 범죄 안전망을 구축하는 데에 크게 기여할 것입니다.
# Team19. eLENS
...
# Team26. yeahcherry
안녕하세요. 26팀 팀장 박채린입니다. 여러분이 만약 지금 정말 만들고 싶은 앱이나 웹 서비스가 있다고 생각해 봅시다. 그러면 그걸 시작하기 위해서 가장 먼저 필요한 것이 무엇일까요? 그건 아마도 뜻이 맞는 팀원들일 것입니다. 그런데 그런 팀원들을 어디서 구할 수 있을까요? 여러분의 친구들이 될 수도 있고, 소개를 받을 수도 있고, 인터넷에서 모집을 할 수도 있을 것입니다. 하지만 여러분도 잘 아시다시피, 적절한 기술스택과 관심사를 가진 사람들을 빠른 시간안에 찾아내기란 생각보다 쉽지 않습니다.

이런 문제로 인해 저희 팀은 개발자와 기획자들의 사이드 프로젝트에 적절한 팀원을 찾아주는 웹서비스를 기획했습니다. 저희 서비스 "Side:Affect"의 핵심 기능은,  AI가 개발자의 이력서와 유사한 프로젝트를 매칭 해주는 것입니다. 여기서 사용할 AI는 데이터에 의존하지 않는 비지도학습 기술을 이용할 것입니다.
그리고 보통 다른 팀원 구인 서비스는 해당 사이트에서 제공하는 형식에 맞춰 자신의 이력을 새로 작성해야 하는 번거로움이 있지만, 저희 서비스는 자기가 평소에 가지고 있는 이력서를 업로드하기만 하면 바로 매칭이 이루어지기 때문에 훨씬 편리하고 시간이 덜 소요된다는 장점이 있습니다.
이 서비스를 통해 많은 개발자와 기획자들이 자신의 프로젝트를 편리하게 시작하고 또 완성할 수 있을 것입니다.
# Team27. ARchive
안녕하세요, 공대생 여러분!
...
# Team33. -
저희가 진행하고 있는 프로젝트는 인공지능을 이용한 차량 사고 과실 비율 분석 서비스입니다. 교통사고는 해마다 무수히 발생하고 있지만 보험사나 전문가를 통해서만 정확한 사고 과실 비율 산정이 가능합니다. 또한 비율 산정 과정에서 분쟁이 일어나게 되면 분쟁해결기구를 통해 분쟁이 해결되는데 이 과정에서 많은 시간과 비용이 소요됩니다. 이에 저희 조는 비전문가들이 믿고 사용할 수 있는 사고 과실 비율 분석 서비스를 R-CNN 모델을 활용하여 만들고자 합니다. 사용자가 웹사이트에 접속하여 교통사고 영상을 업로드합니다. 사용자가 영상을 제출하면 우선 오브젝트 스토리지에 저장한 후,  keras를 통해 학습된 R-CNN 모델이 해당 영상을 어떤 케이스라고 생각되는지 분류하게 됩니다. 그 후 데이터베이스에 저장된 결과는 사용자에게 다시 전송되어 사용자는 과실 비율 산정 결과를 확인할 수 있습니다. 이 서비스는 분쟁 해결 절차를 단순화하고 이 과정에 들어가는 시간과 비용의 소모를 줄여 정확한 과실 비율 판단이 가능하지 않은 많은 일반 운전자들에게 도움을 줄 수 있을 것이라 기대됩니다. 
# Team34. 해오름시샘
